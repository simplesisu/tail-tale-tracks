...
DROP POLICY IF EXISTS "Users can view vaccinations for their pets" ON public.vaccinations;
DROP POLICY IF EXISTS "Users can insert vaccinations for their pets" ON public.vaccinations;
DROP POLICY IF EXISTS "Users can update vaccinations for their pets" ON public.vaccinations;
DROP POLICY IF EXISTS "Users can delete vaccinations for their pets" ON public.vaccinations;
...
DROP POLICY IF EXISTS "Users can view medications for their pets" ON public.medications;
DROP POLICY IF EXISTS "Users can insert medications for their pets" ON public.medications;
DROP POLICY IF EXISTS "Users can update medications for their pets" ON public.medications;
DROP POLICY IF EXISTS "Users can delete medications for their pets" ON public.medications;
...
DROP POLICY IF EXISTS "Users can view weight history for their pets" ON public.weight_history;
DROP POLICY IF EXISTS "Users can insert weight history for their pets" ON public.weight_history;
DROP POLICY IF EXISTS "Users can update weight history for their pets" ON public.weight_history;
DROP POLICY IF EXISTS "Users can delete weight history for their pets" ON public.weight_history;
...
DROP POLICY IF EXISTS "Users can view appointments for their pets" ON public.appointments;
DROP POLICY IF EXISTS "Users can insert appointments for their pets" ON public.appointments;
DROP POLICY IF EXISTS "Users can update appointments for their pets" ON public.appointments;
DROP POLICY IF EXISTS "Users can delete appointments for their pets" ON public.appointments;
...
DROP POLICY IF EXISTS "Users can view documents for their pets" ON public.documents;
DROP POLICY IF EXISTS "Users can insert documents for their pets" ON public.documents;
DROP POLICY IF EXISTS "Users can delete documents for their pets" ON public.documents;
...
DROP POLICY IF EXISTS "Users can view photos for their pets" ON public.photos;
DROP POLICY IF EXISTS "Users can insert photos for their pets" ON public.photos;
DROP POLICY IF EXISTS "Users can delete photos for their pets" ON public.photos;
...
DROP POLICY IF EXISTS "Users can view insurance for their pets" ON public.insurance_info;
DROP POLICY IF EXISTS "Users can insert insurance for their pets" ON public.insurance_info;
DROP POLICY IF EXISTS "Users can update insurance for their pets" ON public.insurance_info;
DROP POLICY IF EXISTS "Users can delete insurance for their pets" ON public.insurance_info;
...
DROP POLICY IF EXISTS "Users can upload documents for their pets" ON storage.objects;
DROP POLICY IF EXISTS "Users can view documents for their pets" ON storage.objects;
DROP POLICY IF EXISTS "Users can delete documents for their pets" ON storage.objects;
DROP POLICY IF EXISTS "Users can upload photos for their pets" ON storage.objects;
DROP POLICY IF EXISTS "Users can view photos for their pets" ON storage.objects;
DROP POLICY IF EXISTS "Users can delete photos for their pets" ON storage.objects;
